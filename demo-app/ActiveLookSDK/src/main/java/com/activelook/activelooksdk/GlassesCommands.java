...
public interface GlassesCommands {
    ...
    // Firmware 1.8 void layoutList(Consumer<List<Integer>> onResult);
    /**
     ...
     */
    void gaugeSave(byte id, short x, short y, short r, short rin, byte start, byte end, boolean clockwise);
    /**
     * Save parameters for a given page.
     *
     * @param id        The id of the page to save.
     * @param r         The orientation of the page.
     * @param layoutIds The ids of the layouts included in the page.
     */
    void pageSave(byte id, Rotation r, byte[] layoutIds);
    // Firmware 1.8 void pageSave(PageInfo page);
    /**
     * Reads saved parameter of a page or all pages.
     *
     * @param onResult Callback on to call on returned value.
     */
    void pageGet(Consumer<List<PageInfo>> onResult);
    // Firmware 1.8 void pageGet(byte id, Consumer<PageInfo> onResult);
    /**
     * Erase a page.
     *
    ...
    // Firmware 1.8 void pageDisplay(byte id, List<String> texts);
    // Firmware 1.8 void pageClear(byte id);
    // Firmware 1.8 void pageList(Consumer<List<Integer>> onResult);
    /**
