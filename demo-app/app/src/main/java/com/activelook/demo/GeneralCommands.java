...
public class GeneralCommands extends MainActivity2 {
    ...
    protected Map.Entry<String, Consumer<Glasses>>[] getCommands() {
        return new Map.Entry[]{
                ...
                item("demo()", glasses -> glasses.demo()),
                item("test(CROSS)", glasses -> glasses.test(DemoPattern.CROSS)),
                item("test(FILL)", glasses -> glasses.test(DemoPattern.FILL)),
                ...
                item("setName(\"My name\")", glasses -> glasses.setName("My name")),
                item("setName(\"\")", glasses -> glasses.setName(""))
        };
    }
